...
st.sidebar.markdown(f"[🔗 Linktree Hesabım](https://linktr.ee/ramazankuzu)")
...
if os.path.exists(FILE_NAME):
    ...
    if df is not None:
        ...
        with f3: 
            pa_araligi = st.slider("🔥 PA Potansiyel:", 0, 200, (130, 200))
    ...
    st.error("⚠️ players_export.csv dosyası bulunamadı!")
