...
def get_announcement():
    try:
        ...
        return res.data[0]['duyuru'] if res.data else "🔥 SOMEKU SCOUT V111 Yayında!"
    except: return "🔥 SOMEKU SCOUT V111 Yayında!"
...
# --- 5. BARROW AI (GENİŞ HAVUZ - PA 135+) ---
with tabs[4]:
    ...
    if st.button("BARROWA SOR"):
        if b_in:
            ...
            # --- GENİŞ HAVUZ MANTIĞI: PA 135 ÜSTÜ TÜM OYUNCULAR ---
            ...
            res_b = bq.order("pa", desc=True).limit(500).execute() # Daha geniş bir havuz çekiyoruz
            ...
            if res_b.data:
                ...
                if final_b:
                    p_b = random.choice(final_b) # Dev havuzdan rastgele seçim
                    ...
                    st.markdown(f'''<div class="player-card" style="border-left-color:#ff0000; background:#000;">
                        ...
                        <a href="{tm_url}" target="_blank" class="tm-link
